...
class Set10ProductImporterTest extends ContainerAwareTestCase
{
    ...
    protected function createXmlParser($xmlFilePath = null)
    {
        ...
        $xmlParser = new Set10ProductImportXmlParser($xmlFilePath);
        return $xmlParser;
    }
    ...
    public function testImport()
    {
        ...
        $subCategoryRepository = $this->getContainer()->get('lighthouse.core.document.repository.classifier.subcategory');
