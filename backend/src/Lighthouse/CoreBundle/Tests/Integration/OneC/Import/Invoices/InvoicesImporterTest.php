...
class InvoicesImporterTest extends WebTestCase
{
    ...
    public function testImport()
    {
        ...
        $storeId1 = $this->factory->store()->createStore(1, 'Магазин Галерея');
        $storeId2 = $this->factory->store()->createStore(2, 'СитиМолл');
        $storeId3 = $this->factory->store()->createStore(3, 'ТК Невский 104');
        $storeId4 = $this->factory->store()->createStore(4, 'ТК НОРД 1-44');
        $storeId5 = $this->factory->store()->createStore(5, 'ТК Пик');
    ...
    {
        $this->markTestSkipped();
        $this->factory->store()->createStore(1, 'Магазин Галерея');
    ...
    {
        $storeId1 = $this->factory->store()->createStore(1, 'Авиаконструкторов 2');
        $storeId2 = $this->factory->store()->createStore(2, 'Есенина 1');
        $storeId3 = $this->factory->store()->createStore(3, 'Металлистов, 116 (МЕ)');
