...
use Lighthouse\IntegrationBundle\Set10\Import\Sales\RemoteDirectory;
...
class Set10SalesImport extends Command
{
     ...
     *      "remoteDirectory" = @DI\Inject("lighthouse.integration.set10.import_sales.remote_directory"),
