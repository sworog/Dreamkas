...
namespace Lighthouse\IntegrationBundle\Tests\Set10\Import\Products;

use Lighthouse\IntegrationBundle\Set10\Import\Products\GoodElement;
use Lighthouse\IntegrationBundle\Set10\Import\Products\Set10ProductImportXmlParser;
...
class Set10ProductImportXmlParserTest extends ContainerAwareTestCase
{
     ...
     */
    protected function createXmlParser($xmlFilePath = 'Set10/Import/Products/goods.xml')
    {
    ...
    {
        $parser = $this->createXmlParser('Set10/Import/Products/goods-invalid.xml');
        do {
            $good = $parser->readNextElement();
        } while ($good);
    }
    ...
    {
        $parser = $this->createXmlParser('Set10/Import/Products/goods-groups.xml');
