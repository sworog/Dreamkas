...
use Lighthouse\IntegrationBundle\Set10\Import\Sales\PositionElement;
use Lighthouse\IntegrationBundle\Set10\Import\Sales\SalesXmlParser;
use Lighthouse\IntegrationBundle\Set10\Import\Sales\PurchaseElement;
...
class SalesXmlParserTest extends ContainerAwareTestCase
{
     ...
     */
    protected function createXmlParser($xmlFile = 'Set10/Import/Sales/purchases-14-05-2012_9-18-29.xml')
    {
    ...
    public function testReadNextNode()
    {
        ...
        $this->assertInstanceOf(PositionElement::getClassName(), $position);
