...
EOF;
    ...
    public function testWriteRemoteFile()
    {
        ...
        $this->assertXmlFileEqualsXmlFile(
            $this->getFixtureFilePath('Set10/Export/Products/ExportProducts.xml'),
            array_pop($files)
        );
    }
    ...
    public function testProductBarcodeUpdatesDoesNotExport()
    {
        ...
        $files = glob($xmlFilePath . '/source/*');
        $this->assertXmlFileEqualsXmlFile(
            $this->getFixtureFilePath('Set10/Export/Products/ExportProductsUpdated.xml'),
            array_pop($files)
        );
    }
