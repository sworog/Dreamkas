...
use Lighthouse\IntegrationBundle\Command\Import\Set10ProductsImport;
use Lighthouse\IntegrationBundle\Set10\Import\Products\Set10ProductImporter;
...
class Set10ProductsImportTest extends ContainerAwareTestCase
{
    ...
    {
        $input = array(
            'file' => $this->getFixtureFilePath('Set10/Import/Products/goods.xml'),
            '--batch-size' => 4
        );
    ...
    {
        $input = array(
            'file' => $this->getFixtureFilePath('Set10/Import/Products/GoodsFolder'),
        );
    ...
    {
        $input = array(
            'file' => $this->getFixtureFilePath('Set10/Import/Products/goods-invalid.xml'),
        );
    ...
    {
        $input = array(
            'file' => $this->getFixtureFilePath('Set10/Import/Products/goods-invalid-not-found.xml'),
        );
