...
class Set10SalesImportLocalTest extends WebTestCase
{
    ...
    protected function execute($input, $project = null)
    {
        ...
        if (is_string($input)) {
            $arrayInput['file'] = $this->getFixtureFilePath('Set10/Import/Sales/' . $input);
    ...
    public function testDryRun()
    {
        ...
        $commandTester = $this->execute(
            array(
                'file' => $this->getFixtureFilePath('Set10/Import/Sales/Kesko'),
                '--dry-run' => true,
...
EOF;
    ...
    public function testDryRunWithStartAndEndDatesAndInvalidFile()
    {
        ...
        $commandTester = $this->execute(
            array(
                'file' => $this->getFixtureFilePath('Set10/Import/Sales/purchases-invalid.xml'),
                '--dry-run' => true,
                '--import-date' => '2013-12-01',
                '--receipt-date' => '2013-11-04',
                '--project' => $project->getName()
...
EOF;
    ...
    public function testDryRunWithStartAndEndDatesAndEmptyFile()
    {
        ...
        $commandTester = $this->execute(
            array(
                'file' => $this->getFixtureFilePath('Set10/Import/Sales/purchases-empty.xml'),
                '--dry-run' => true,
                '--import-date' => '2013-12-01',
                '--receipt-date' => '2013-11-04',
                '--project' => $project->getName(),
...
EOF;
    ...
    public function testProfile()
    {
        ...
        $commandTester = $this->execute(
            array(
                'file' => $this->getFixtureFilePath('Set10/Import/Sales/purchases-14-05-2012_9-18-29.xml'),
                '--profile' => true,
                '--project' => $project->getName()
            )
        );
    ...
    public function testSortByFileDate()
    {
        ...
        $commandTester = $this->execute(
            array(
                'file' => $this->getFixtureFilePath('Set10/Import/Sales/ADM'),
                '--sort' => 'filedate',
                '--project' => $project->getName()
            )
        );
    ...
    public function testOnlyPurchaseFilesAreImportedOnFileDateSort()
    {
        ...
        $commandTester = $this->execute(
            array(
                'file' => $this->getFixtureFilePath('Set10/Import/Sales/PurchasesDiscounts'),
                '--sort' => 'filedate',
                '--project' => $project->getName()
            )
        );
