...
import ru.dreamkas.thucydides.RemoteWebDriverEventListener;
...
public class AcceptanceTestSuite extends ThucydidesJUnitStories {
    ...
    private void setWaitTimeOuts() {
        TimeOutConfigurable configurationStorage = DefaultStorage.getTimeOutConfigurationVariableStorage();
    ...
    private void setDemoMode() {
        ...
        DefaultStorage.getDemoModeConfigurableStorage().setIsDemoModeOn(isDemoModeOn);
    }
