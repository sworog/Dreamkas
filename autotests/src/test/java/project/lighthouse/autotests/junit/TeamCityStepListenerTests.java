...
public class TeamCityStepListenerTests {
    ...
    private final TeamCityStepListener originalTeamCityStepListener = new TeamCityStepListener(logger);
    private final TeamCityStepListener teamCityStepListener = spy(originalTeamCityStepListener);

    private static final String STORY_PATH = "stories/sprint-1/us-1/1_Scenario.story";
    ...
    @Before
    public void before() {
        doReturn("StackTrace").when(teamCityStepListener).getStackTrace(Mockito.any(Throwable.class));
    }
    ...
    public void scenarioResultIsSuccess() {
        ...
        String testFinishedExpectedMessage = "##teamcity[testFinished  duration='100' name='sprint-1.us-1.1_Scenario.passedScenario']";
    ...
    public void scenarioResultIsFailure() {
        ...
        String testFailedExpectedMessage = "##teamcity[testFailed  message='the test is failed!' details='Steps:|r|nFailed scenario step (0.0) -> ERROR|r|n|nStackTrace|r|n|r|n' name='sprint-1.us-1.1_Scenario.failedScenario']";
    ...
    public void scenarioChildStepResultIsFailure() {
        ...
        when(testOutcome.getPath()).thenReturn(STORY_PATH);
