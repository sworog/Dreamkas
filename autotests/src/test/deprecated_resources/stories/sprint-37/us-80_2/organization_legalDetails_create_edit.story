...
Scenario: Edit legal details on organization IP
...
Then the user sees success message 'Данные успешно сохранены'
And user checks legal details fields data
Given user is on organization page name 'organization-s37us802_5'
When user clicks legal details link
And user selects legal details type 'Индивидуальный предприниматель'
And user fill legal details inputs
 | elementName | value |
...
Then the user sees success message 'Данные успешно сохранены'
And user checks legal details fields data
Given user is on organization page name 'organization-s37us802_6'
When user clicks legal details link
And user selects legal details type 'Индивидуальный предприниматель'
And user fill legal details inputs
 | elementName | value |
...
Scenario: Edit legal details on organization legalEntity
...
Then the user sees success message 'Данные успешно сохранены'
And user checks legal details fields data
Given user is on organization page name 'organization-s37us802_7'
When user clicks legal details link
And user selects legal details type 'Юридическое лицо'
And user fill legal details inputs
 | elementName | value |
