...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении поле дата
...
Scenario: Отсутствия сообщения о потери данных в вовзратах поставщику при изменении поля дата и возвращении старого значения
...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении поля магазин
...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении поля поставщик
...
Scenario: Отсутствия сообщения о потери данных в вовзратах поставщику при изменении поля поставщик и возвращении старого значения
...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении галочки оплачено
...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении автокомплитного поля поиска товара
...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении поля цена товара
...
Scenario: Появление сообщения о потери данных в вовзратах поставщику при изменении поля кол-во товара
