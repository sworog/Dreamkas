...
Я хочу видеть предупреждение, закрывая форму приёмки, оприходования, списания, возврата поставщику, редактирования товара, создания поставщика, создания магазина, о том, что введённые данные не будут сохранены,
...
When пользователь нажимает на товар с названием 'user-product1'
