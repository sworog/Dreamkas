...
And there is the store with number 'UIBS-FF' managed by department manager named 'departmentManager-UIBS-FF'
Given there is the subCategory with name 'ProductsUpdateWriteOffSubCategory' related to group named 'ProductsUpdateWriteOffGroup' and category named 'ProductsUpdateWriteOffCategory'
And there is the product with '7300330094026' name, '7300330094025 ' barcode, 'unit' type, '97,60' purchasePrice of group named 'ProductsUpdateWriteOffGroup', category named 'ProductsUpdateWriteOffCategory', subcategory named 'ProductsUpdateWriteOffSubCategory'
...
And there is the store with number 'UIBS-FF' managed by department manager named 'departmentManager-UIBS-FF'
Given there is the subCategory with name 'ProductsUpdateWriteOffSubCategory' related to group named 'ProductsUpdateWriteOffGroup' and category named 'ProductsUpdateWriteOffCategory'
And there is the product with '7300330094027' name, '7300330094025 ' barcode, 'unit' type, '97,60' purchasePrice of group named 'ProductsUpdateWriteOffGroup', category named 'ProductsUpdateWriteOffCategory', subcategory named 'ProductsUpdateWriteOffSubCategory'
And there is the writeOff in the store with number 'UIBS-FF' ruled by department manager with name 'departmentManager-UIBS-FF' with values
| elementName | elementValue |
| number | WOUIBS-FF-02 |
| date | 02.04.2013 |
...
And there is the store with number 'UIBS-FF' managed by department manager named 'departmentManager-UIBS-FF'
Given there is the subCategory with name 'ProductsUpdateWriteOffSubCategory' related to group named 'ProductsUpdateWriteOffGroup' and category named 'ProductsUpdateWriteOffCategory'
And there is the product with '7300330094028' name, '7300330094025 ' barcode, 'unit' type, '97,60' purchasePrice of group named 'ProductsUpdateWriteOffGroup', category named 'ProductsUpdateWriteOffCategory', subcategory named 'ProductsUpdateWriteOffSubCategory'
And there is the writeOff in the store with number 'UIBS-FF' ruled by department manager with name 'departmentManager-UIBS-FF' with values
| elementName | elementValue |
| number | WOUIBS-FF-03 |
| date | 05.04.2013 |
...
And there is the store with number 'UIBS-FF' managed by department manager named 'departmentManager-UIBS-FF'
Given there is the subCategory with name 'ProductsUpdateWriteOffSubCategory' related to group named 'ProductsUpdateWriteOffGroup' and category named 'ProductsUpdateWriteOffCategory'
And there is the product with '7300330094020' name, '7300330094025 ' barcode, 'unit' type, '97,60' purchasePrice of group named 'ProductsUpdateWriteOffGroup', category named 'ProductsUpdateWriteOffCategory', subcategory named 'ProductsUpdateWriteOffSubCategory'
And there is the writeOff in the store with number 'UIBS-FF' ruled by department manager with name 'departmentManager-UIBS-FF' with values
| elementName | elementValue |
| number | WOUIBS-FF-05 |
| date | 02.04.2013 |
