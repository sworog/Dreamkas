...
Given the user navigates to the invoice page with name '25521-01'
When the user logs in using 'departmentManager-s25u521' userName and 'lighthouse' password
...
| name-255217 | 255217 | 255217 | 12,0 | шт. | 100,00 | 1 200,00 | 0,00 р. | 0 |
...
Then the user checks the invoice products list contains entry
| productName | productSku | productBarcode | productAmount | productUnits | productPrice | productSum | vatSum | vat |
| name-255218 | 255218 | 255218 | 85,56 | шт. | 100,00 | 8 556,00 | 0,00 р. | 0 |
...
Then the user checks the invoice products list contains entry
| productName | productSku | productBarcode | productAmount | productUnits | productPrice | productSum | vatSum | vat |
| name-255219 | 255219 | 255219 | 43,196 | шт. | 100,00 | 4 319,60 | 0,00 р. | 0 |
