...
When пользователь* находится на странице 'модальное окно создания оприходования'
...
When пользователь* находится на странице 'модальное окно редактирования оприходования'
