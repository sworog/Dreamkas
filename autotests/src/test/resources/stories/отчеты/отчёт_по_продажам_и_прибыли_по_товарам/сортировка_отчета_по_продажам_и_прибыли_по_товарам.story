...
Scenario: Проверка, что сортировка отчета о продажах и прибыли по товарам группы по умолчанию выставлена на колонку наименования и сортируется по возрастанию
...
When пользователь* находится на странице 'странице отчета по продажам и прибыли по товарам группы'
...
| reports-group1 | 600,00 (31,6%) | 300,00 | 300,00 (30%) |
| reports-group1 | 1 000,00 (52,6%) | 400,00 | 600,00 (60%) |
