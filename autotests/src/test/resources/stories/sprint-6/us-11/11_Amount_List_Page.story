...
And the user navigates to the invoice page with name 'Invoice-ADADAD-11'
...
And the user navigates to the invoice page with name 'Invoice-ADADAD-22'
And the user logs in as 'departmentManager'
...
And the user navigates to the invoice page with name 'Invoice-ADADAD-33'
And the user logs in as 'departmentManager'
