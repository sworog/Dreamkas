...
And the user is on the invoice list page
When the user open the invoice card with 'Invoice-IE-APCVSE' sku
And the user clicks edit button and starts invoice edition
And the user inputs '!неттакого' in the invoice product 'productSku' field
...
When the user open the invoice card with 'Invoice-IE-APCVSE' sku
And the user clicks edit button and starts invoice edition
And the user inputs '!неттакого' in the invoice product 'productName' field
And the user clicks finish edit button and ends the invoice edition
Then the user checks alert text is equal to 'У вас есть несохранённые данные'
...
When the user open the invoice card with 'Invoice-IE-APCVSE' sku
And the user clicks edit button and starts invoice edition
And the user inputs '!неттакого' in the invoice product 'productBarCode' field
And the user clicks finish edit button and ends the invoice edition
Then the user checks alert text is equal to 'У вас есть несохранённые данные'
...
When the user open the invoice card with 'Invoice-IE-APCVSE' sku
And the user clicks edit button and starts invoice edition
And the user inputs 'неттакого' in the invoice product 'productAmount' field
And the user clicks finish edit button and ends the invoice edition
Then the user checks alert text is equal to 'У вас есть несохранённые данные'
...
Given there is the product with 'IE-IPE' name, 'IE-IPE' sku, 'IE-IPE' barcode
And there is the product with 'IE-IPA-1' name, 'IE-IPA-1' sku, 'IE-IPA-1' barcode, 'liter' units
And there is the invoice with 'Invoice-IE-AIOVOSSE' sku
When the user inputs 'IE-IPE' in the invoice product 'productName' field
And the user inputs '1' in the invoice product 'productAmount' field
And the user inputs '2' in the invoice product 'invoiceCost' field
And the user clicks the invoice create button
Then the user checks the invoice with 'Invoice-IE-AIOVOSSE' sku is present
When the user open the invoice card with 'Invoice-IE-AIOVOSSE' sku
And the user clicks edit button and starts invoice edition
When the user clicks on 'productBarcode' element of invoice product with 'IE-IPE' sku
And the user inputs 'IE-IPE-1' in the invoice 'inline productBarCode' field
And the user clicks finish edit button and ends the invoice edition
...
Given there is the product with 'IE-IPE' name, 'IE-IPE' sku, 'IE-IPE' barcode
And there is the product with 'IE-IPA-1' name, 'IE-IPA-1' sku, 'IE-IPA-1' barcode, 'liter' units
And there is the invoice with 'Invoice-IE-AIOVOSSE1' sku
When the user inputs 'IE-IPE' in the invoice product 'productName' field
And the user inputs '1' in the invoice product 'productAmount' field
And the user inputs '2' in the invoice product 'invoiceCost' field
And the user clicks the invoice create button
Then the user checks the invoice with 'Invoice-IE-AIOVOSSE1' sku is present
When the user open the invoice card with 'Invoice-IE-AIOVOSSE1' sku
And the user clicks edit button and starts invoice edition
When the user clicks on 'productBarcode' element of invoice product with 'IE-IPE' sku
And the user inputs 'IE-IPE-1' in the invoice 'inline productBarCode' field
And the user clicks finish edit link and ends the invoice edition
...
Then the user checks alert text is equal to 'У вас есть несохранённые данные'
When the user clicks Cancel and discard changes
When the user clicks on 'quantity' element of invoice product with 'IE-IPE-1' sku
And the user inputs '2' in the invoice 'inline productAmount' field
And the user clicks finish edit link and ends the invoice edition
Then the user checks alert text is equal to 'У вас есть несохранённые данные'
When the user clicks Cancel and discard changes
When the user clicks on 'productPrice' element of invoice product with 'IE-IPE-1' sku
