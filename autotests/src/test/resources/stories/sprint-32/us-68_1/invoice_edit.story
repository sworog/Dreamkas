...
And the user checks the invoice vat sum is 'Итого: 220,00 руб'
...
And the user checks the invoice vat sum is 'Итого: 1 320,00 руб'

Then the user checks the invoice products list contains exact entries
| name | units |quantity | retailPrice | totalSum | vatSum |
| {lastCreatedProductName} | шт. | 2,0 | 100,00 | 200,00 | 3434 |
| name-s32u681s1 | кг | 10,0 | 123,00 | 1 230,00 | 3434 |
...
Scenario: Invoice supplier edit - check supplier on invoices list page
...
Scenario: Invoice supplier edit - check supplier on invoices list page cancel
...
Then the user checks the invoice products list contains exact entries
| name | units |quantity | retailPrice | totalSum | vatSum |
| {lastCreatedProductName} | шт. | 1,0 | 100,00 | 100,00 | sdsd |
| name-s32u681s1 | кг | 10,0 | 123,00 | 1 230,00 | sdsd |
