...
Scenario: Invoice accepter date range negative validation
...
Scenario: Invoice accepter date range positive validation
...
| -1,123 | Цена не должна быть меньше или равна нулю |
...
| ЦЕНА | Значение должно быть числом |
| @#$#$# | Значение должно быть числом |
| 10000001 | ена не должна быть больше 10000000 |