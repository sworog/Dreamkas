...
| 01.10.2014 | Приёмка | / оплачена | В s39u102-store | 750,00 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| todayDate-4 | Приёмка | / не оплачена | В s39u102-store1 | 875,50 |
...
When пользователь* находится в модальном окне 'редактирования приемки'

Then пользователь* в модальном окне проверяет, что поле с именем 'заголовок успешного удаления' имеет значение 'Приемка удалена'
...
Scenario: Проверка смены галочки Оплачено у накладной
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| todayDate-5 | Приёмка | / не оплачена | В s39u102-store | 750,00 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| todayDate-5 | Приёмка | / оплачена | В s39u102-store | 750,00 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| todayDate-4 | Приёмка | / не оплачена | В s39u102-store1 | 125,50 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| 01.10.2014 | Приёмка | / оплачена | В s39u102-store | 600,00 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| 01.10.2014 | Приёмка | / не оплачена | В s39u102-store | 1 515,00 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | status | store | sumTotal |
| todayDate-5 | Приёмка | / не оплачена | В s39u102-store | 850,56 |
