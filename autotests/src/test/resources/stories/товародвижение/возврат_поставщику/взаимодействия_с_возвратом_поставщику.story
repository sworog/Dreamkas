...
| 08.11.2014 | Возврат поставщику | Из s40u105-store1 | / не погашен | 750,00 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | store | status | sumTotal |
| 08.11.2014 | Возврат поставщику | Из s40u105-store1 | / погашен | 1 116,80 |
...
Then пользователь проверяет операции на странице товародвижения
| date | type | store | status | sumTotal |
| 08.11.2014 | Возврат поставщику | Из s40u105-store1 | / погашен | 125,50 |
