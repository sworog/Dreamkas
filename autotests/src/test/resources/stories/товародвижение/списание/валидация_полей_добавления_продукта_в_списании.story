...
Scenario: Валидация полей добавления продукта в списание - текст плейсхолдера поля причина

Meta:
@sprint_41
@tech_41
@regression
@id s40u103InvoiceProductValidations3.1
...
When пользователь нажимает на кнопку Списать на странице товародвижения
And пользователь* находится в модальном окне 'создания списания'
Then пользователь проверяет, что плейсхолдер поля причина в модальном окне создания списания содержит 'Причина'
