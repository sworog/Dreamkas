...
Scenario: Создание нового товар и группы из создания товара в приемке, когда товаров нет
...
And пользователь проверяет, что у элемента с именем 'product.name' css 'background-color' имеет значение 'rgba(241, 255, 241, 1)'
...
Scenario: Создание нового товар из создания товара в приемке, когда товары и группа есть
...
Scenario: Подсветка поля после выбора товара
...
Then пользователь проверяет, что у элемента с именем 'product.name' css 'background-color' имеет значение 'rgba(241, 255, 241, 1)'