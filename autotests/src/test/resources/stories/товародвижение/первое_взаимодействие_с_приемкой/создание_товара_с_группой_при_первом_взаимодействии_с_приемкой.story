...
Scenario: Создание новой группы из создания товара в приемке, когда нет групп
...
Scenario: Создание новой группы из создания товара в приемке, когда группы есть
...
Scenario: Создание нового товара и группы из создания товара в приемке, когда товаров нет
...
Scenario: Создание нового товара из создания товара в приемке, когда товары и группа есть
...
Scenario: Подсветка поля после выбора товара в модальном окне приемки
