...
Then the user checks the product balance list contains entry
| name | sku | barcode | inventory | averageDailySales | inventoryDays | lastPurchasePrice | averagePurchasePrice |
| name-s23u50-1 | sku-s23u50-1 | barcode-s23u50-1 | 0,0 | 0,0 | 0,0 | — | — |
...
Then the user checks the product balance list contains entry
| name | sku | barcode | inventory | averageDailySales | inventoryDays | lastPurchasePrice | averagePurchasePrice |
| name-s23u50-2 | 280046544 | 280046544 | 90,0 | 0,0 | 0,0 | 120,00 р. | 120,00 р. |
...
Then the user checks the product balance list contains entry
| name | sku | barcode | inventory | averageDailySales | inventoryDays | lastPurchasePrice | averagePurchasePrice |
| name-s23u50-3 | 2800465441 | 2800465441 | 90,0 | 0,0 | 0,0 | 120,00 р. | 120,00 р. |
