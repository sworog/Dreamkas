...
| Балык свиной в/с в/об Матера | #sku:Балык свиной в/с в/об Матера | 2800465 | 39,0 | 0,17 | 229,4 | 312,80 р. | 298,64 р. |
| Балык Ломберный с/к в/с ТД Рублевский | #sku:Балык Ломберный с/к в/с ТД Рублевский | 2805223 | 32,0 | 0,37 | 86,5 | 678,40 р. | 682,59 р. |
| Ассорти Читтерио мясное нар.140г | #sku:Ассорти Читтерио мясное нар.140г | 80469353 | 33,0 | 1,13 | 29,2 | 449,60 р. | 459,81 р. |
...
Then the user checks the product balance list contains entry
| name | sku | barcode | inventory | averageDailySales | inventoryDays | lastPurchasePrice | averagePurchasePrice |
| name-s23u50-1 | #sku:name-s23u50-1 | barcode-s23u50-1 | 0,0 | 0,0 | 0,0 | — | — |
...
Then the user checks the product balance list contains entry
| name | sku | barcode | inventory | averageDailySales | inventoryDays | lastPurchasePrice | averagePurchasePrice |
| name-s23u50-2 | #sku:name-s23u50-2 | 280046544 | 90,0 | 0,0 | 0,0 | 120,00 р. | 120,00 р. |
...
Then the user checks the product balance list contains entry
| name | sku | barcode | inventory | averageDailySales | inventoryDays | lastPurchasePrice | averagePurchasePrice |
| name-s23u50-3 | #sku:name-s23u50-3 | 2800465441 | 90,0 | 0,0 | 0,0 | 120,00 р. | 120,00 р. |
...
When the user logs in using 'departmentManager-s23u50' userName and 'lighthouse' password
And the user opens product balance tab
Then the user checks the balance list item by name 'name-s23u50-1' has items not visible
| items |
| Остаток, шт. |
| ССО, шт. |
| УТЗ, дн. |
| Последняя |
| Средняя |
Then the user checks the balance list item by name 'name-s23u50-1' has items become visible while hovering
