...
Then пользователь* в модальном окне проверяет, что поле с именем 'сумма к оплате' имеет значение '110,00'

When пользователь* в модальном окне вводит значение 'Банковской картой' в поле с именем 'тип оплаты'
...
Then пользователь* в модальном окне проверяет, что поле с именем 'сдача' имеет значение '40,00'
...
When пользователь* в модальном окне вводит значение '109,999' в поле с именем 'внесенная сумма наличными'

Then пользователь* в модальном окне проверяет, что поле с именем 'сдача' имеет значение '0,00'
...
Then пользователь* в модальном окне проверяет, что поле с именем 'тип оплаты по умолчанию' имеет значение 'Наличными'
...
When пользователь* в модальном окне вводит значение value в поле с именем 'внесенная сумма наличными'

Then пользователь* в модальном окне проверяет, что поле с именем 'сдача' имеет значение expectedValue
