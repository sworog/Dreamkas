...
Я хочу чтобы кассы могли продавать товар по дополнительным ШК с учетом количества товара и специальной цены,
Чтобы использовать возможности продажи товара в упаковках, перемаркировали и т.п.

Scenario: Export product with extra barcodes to centrum (xml)
...
GivenStories: precondition/customPrecondition/symfonyEnvInitPrecondition.story,
              precondition/sprint-34/us-71_1/aPreconditionWithData.story
...
Then the robot checks xml file in autotests folder for equals fixture file 'fixtures/products/productWithExtraBarcodeExport.xml'
