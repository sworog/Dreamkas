...
Then пользователь* в модальном окне проверяет, что поле с именем 'заголовок успешного удаления денежной операции' имеет значение 'Денежная операция удалена'
