...
Then пользователь проверяет, что у поля с именем 'product.name' имеется сообщения об ошибке с сообщением 'Заполните это поле' в модальном окне создания накладной
...
Then пользователь проверяет, что у поля с именем 'product.name' имеется сообщения об ошибке с сообщением 'Такого товара не существует' в модальном окне создания накладной
...
Then пользователь проверяет, что у поля с именем 'priceEntered' имеется сообщения об ошибке с сообщением 'Заполните это поле' в модальном окне создания накладной
...
Then пользователь проверяет, что у поля с именем 'quantity' имеется сообщения об ошибке с сообщением 'Заполните это поле' в модальном окне создания накладной
