Scenario: Viewing product in the product list
...
Scenario: View the product card from product list page
Scenario: Redirect from CreateNewProduct page to product list
