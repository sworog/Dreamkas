...
| number | SCPBC-11 |
| date | 02.04.2013 |
And the user adds the product to the write off with number 'SCPBC-11' with name 'SCPBC-name-11', quantity '1', price '12,34', cause 'Плохо продавался' in the store ruled by 'departmentManager-SCPBC'
