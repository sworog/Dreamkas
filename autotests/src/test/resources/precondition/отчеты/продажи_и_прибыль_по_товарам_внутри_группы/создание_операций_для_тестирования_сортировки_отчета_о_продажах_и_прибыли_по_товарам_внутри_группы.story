...
Scenario: Cоздание операций для тестирования сортировки отчета о продажах и прибыли по товарам внутри группы
...
And пользователь с адресом электронной почты 'reports@lighthouse.pro' создает продукт с именем 'reports-product3', еденицами измерения 'шт.', штрихкодом 'reports-barcode-3', НДС '0', ценой закупки '100' и ценой продажи '110' в группе с именем 'reports-group1'
