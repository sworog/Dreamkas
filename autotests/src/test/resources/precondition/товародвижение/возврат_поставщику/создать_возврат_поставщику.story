...
Given пользователь создает апи объект возвратом поставщику с датой '25.08.2014', статусом Оплачено 'true', магазином с именем 's40u105-store1', поставщиком с именем 's40u105-supplier1'
