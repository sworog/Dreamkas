...
Given there is the date invoice with sku 'Invoice-27541' and date 'today-2days' in the store with number '27541' ruled by department manager with name 'storeManager-s27u541'
And the user adds the product to the invoice with name 'Invoice-27541' with sku '27541', quantity '50', price '90' in the store ruled by 'storeManager-s27u541'

Given there is the date invoice with sku 'Invoice-27541' and date 'today-1days' in the store with number '27541' ruled by department manager with name 'storeManager-s27u541'
And the user adds the product to the invoice with name 'Invoice-27541' with sku '27541', quantity '35', price '100' in the store ruled by 'storeManager-s27u541'
