package project.lighthouse.autotests.pages.deprecated.commercialManager.store;
...
public class StoreCardPage extends CommonPageObject {
    ...
    public void checkStoreCardHeader(String header) {
        String storeNumber = findVisibleElement(
                By.xpath("//*[@model-attribute='number' and @model='store']")
        ).getText();
        assertEquals(
    ...
    public WebElement findPromotedStoreManager(String value) {
        return findVisibleElement(
                By.xpath(
                        String.format("//*[not(contains(@class, 'store__storeManagerItem preloader_rows'))]/*[@model-attribute='name' and @model='user' and text()='%s']", value)
                )
        );
    }
    ...
    public WebElement findPromotedDepartmentManager(String value) {
        return findVisibleElement(
                By.xpath(
                        String.format("//*[not(contains(@class, 'store__departmentManagerItem preloader_rows'))]/*[@model-attribute='name' and @model='user' and text()='%s']", value)
                )
        );
    }
