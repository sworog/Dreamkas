...
public class Us_53_1_Fixture {
    ...
    public File prepareYesterdayData() throws ParserConfigurationException, XPathExpressionException, TransformerException, IOException {
        ...
        PurchaseXmlBuilder purchaseXmlBuilder = new PurchaseXmlBuilder().createXmlPurchases("24")
                ...
                .addXmlPurchase(getDate(todayDate, "22"), todayDate, shopNumber, "2640.00", price, "22", id)
                .addXmlPurchase(getDate(todayDate, "23"), todayDate, shopNumber, "2760.00", price, "23", id)
                .addXmlPurchase(getDate(todayDate, "24"), todayDate, shopNumber, "120.00", price, "1", id);
        File file = new File(System.getProperty("user.dir") + "/xml/out/u24s531s1.xml");
        FileUtils.writeStringToFile(file, purchaseXmlBuilder.asString());
        return file;
    }

    public String getAllGrossSalesYesterdayValue() {
        return "33240";
    }

    public File prepareLastWeekData() throws ParserConfigurationException, XPathExpressionException, TransformerException, IOException {
        ...
        PurchaseXmlBuilder purchaseXmlBuilder = new PurchaseXmlBuilder().createXmlPurchases("24")
                ...
                .addXmlPurchase(getDate(todayDate, "22"), todayDate, shopNumber, "2640.00", price, "22", id)
                .addXmlPurchase(getDate(todayDate, "23"), todayDate, shopNumber, "2760.00", price, "23", id)
                .addXmlPurchase(getDate(todayDate, "24"), todayDate, shopNumber, "240.00", price, "2", id);
        File file = new File(System.getProperty("user.dir") + "/xml/out/u24s531s1.xml");
        FileUtils.writeStringToFile(file, purchaseXmlBuilder.asString());
        return file;
    }

    public String getAllGrossSalesLastWeekDayValue() {
        return "33360";
    }
}
