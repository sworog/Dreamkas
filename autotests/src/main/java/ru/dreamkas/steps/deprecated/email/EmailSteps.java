package ru.dreamkas.steps.deprecated.email;

import net.thucydides.core.annotations.Step;
import net.thucydides.core.steps.ScenarioSteps;
import ru.dreamkas.handler.email.EmailHandler;
import ru.dreamkas.handler.email.EmailMessage;
...
public class EmailSteps extends ScenarioSteps {
    ...
    private static final String SIGN_UP_REGEX_PATTERN = "Добро пожаловать в Dreamkas!\r\n\r\nВаш пароль для входа: (.*)\r\nЕсли это письмо пришло вам по ошибке, просто проигнорируйте его.\r\n";
    private static final String RESTORE_PASSWORD_REGEX_PATTERN = "Вы воспользовались формой восстановления пароля в Dreamkas.\r\n\r\nВаш новый пароль для входа: (.*)\r\n-----\r\nDreamkas.ru\r\n";
