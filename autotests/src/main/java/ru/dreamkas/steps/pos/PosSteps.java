...
import ru.dreamkas.collection.receipt.ReceiptObject;
import ru.dreamkas.collection.refund.RefundProduct;
import ru.dreamkas.common.item.interfaces.Collectable;
import ru.dreamkas.pages.pos.*;
...
public class PosSteps extends ScenarioSteps {
    ...
    public void assertStoreProductInventory(String email, String storeName, String productName, String inventory) throws IOException, JSONException {
        ...
        String storeId = ApiStorage.getCustomVariableStorage().getStores().get(storeName).getId();
        String productId = ApiStorage.getCustomVariableStorage().getProducts().get(productName).getId();
