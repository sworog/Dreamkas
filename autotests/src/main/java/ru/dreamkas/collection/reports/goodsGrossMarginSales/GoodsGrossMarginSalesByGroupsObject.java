...
public class GoodsGrossMarginSalesByGroupsObject extends AbstractObject implements ResultComparable, ObjectLocatable, ObjectClickable {
    ...
    public GoodsGrossMarginSalesByGroupsObject(WebElement element) {
        super(element);
    }
