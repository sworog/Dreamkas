...
public class BluetoothService {
    ...
    private static final UUID UUID_ANDROID_DEVICE =
            UUID.fromString("fa87c0d0-afac-11de-8a39-0800288c9a66");
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            final ArrayList<Integer> arr_byte = new ArrayList<Integer>();
        ...
        private void sendMessage(ArrayList<Integer> arr_byte) {
            byte[] buffer;
