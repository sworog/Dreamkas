...
And пользователь с адресом электронной почты 'androidpos@lighthouse.pro' создает продукт с именем 'Товар без цены продажи', еденицами измерения 'пятюни', штрихкодом '666666', НДС '18', ценой закупки '80' и ценой продажи '' в группе с именем 'Товары'