...
Then пользователь видит что кнопка перешла в режим ожидания подтверждения с надписью 'Подтвердить очистку чека'
...
Then пользователь видит что кнопка перешла в режим ожидания подтверждения с надписью 'Очистить чек'
