define(function(require, exports, module) {
    ...
    return Form.extend({
        ...
        render: function(){
            ...
            $(block.el).find('.form_orderProduct__retailPrice').html(_.escape(block.storeProduct.retailPrice) || '');
            $(block.el).find('.form_orderProduct__totalSum').html(_.escape(block.model.get('amount')) * _.escape(block.storeProduct.retailPrice) || '');
