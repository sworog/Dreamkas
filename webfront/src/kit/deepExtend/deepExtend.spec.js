define(function(require, exports, module) {
    ...
    var deepExtend = require('./deepExtend'),
        objectFixture = require('./mockObject');
    ...
    describe(module.id, function() {
        ...
        it('all prop assigned by value', function(){
            var object = deepExtend({}, object2);

            object.object.object.string = 1;

            expect(object2.object.object.string).toEqual('test string level 3 object2');
        });
